...
int main(int argc, char** argv) {
    ...
    std::cout << "  - Default Anti-Ghost Layout:" << std::endl;
    std::cout << "    P1 (Hirono): [W][A][D] move, [C][V][B] attack/skill/ult" << std::endl;
    std::cout << "    P2 (Dimoo) : [I][J][L] move, [U][O][P] attack/skill/ult" << std::endl;
    std::cout << "  - Legacy Layout Toggle: [F3] switches to P1 [W][A][D][J][K][L], P2 [ARROWS][1][2][3]" << std::endl;
    ...
    std::cout << "  - []] : Launch the folded instructions leaflet (legacy debug key)" << std::endl;
